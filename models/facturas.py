...
class Factura(models.Model):
    ...
    linea_ids = fields.One2many('facturas.factura.linea', 'factura_id', string='Líneas de Factura')
...
class FacturaLinea(models.Model):
    ...
    factura_id = fields.Many2one('facturas.factura', string='Factura', ondelete='cascade')
